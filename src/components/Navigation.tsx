...
export function Navigation() {
  ...
  return (
    <nav className="sticky top-0 z-50 glass border-b border-yellow-500/20">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-2">
            ...
            <div className="hidden sm:block">
              <span className="text-xl font-bold text-white">Institut</span>
              <span className="text-xl font-bold text-yellow-500">Biznisa</span>
            </div>
          </Link>
